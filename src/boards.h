...
#define NUM_OF_BOARDS		21	/* change if needed! */
#define MAX_BOARD_MESSAGES 	45      /* arbitrary -- change if needed*/
#define MAX_MESSAGE_LENGTH	2048	/* arbitrary -- change if needed */
