...
#define NUM_SHOT_TYPES          9

#define NUM_GENDERS		3
#define NUM_SHOP_FLAGS 		2
#define NUM_TRADERS 		7

#define LVL_OLC		LVL_OVERSEER
...
#define GET_OLC_ZONE1(c) ((c)->player_specials->saved.olc_zone[0])
#define GET_OLC_ZONE2(c) ((c)->player_specials->saved.olc_zone[1])
#define GET_OLC_ZONE3(c) ((c)->player_specials->saved.olc_zone[2])
#define GET_OLC_ZONE4(c) ((c)->player_specials->saved.olc_zone[3])
#define GET_OLC_ZONE5(c) ((c)->player_specials->saved.olc_zone[4])
...
#define ZEDIT_LVLS			14
#define ZEDIT_LVLS_2			15
#define ZEDIT_APPROVE			16
#define ZEDIT_MIN_LVL			17
#define ZEDIT_MAX_LVL			18
