...
#define TRADE_NOHUMP  	    8
#define TRADE_NOSTROKE		16
#define TRADE_NOBANG 		32
#define TRADE_NOEFF 		64
#define TRADE_NOFUM 		128
#define TRADE_NODIG 		256
#define TRADE_NOPURR        512
...
#define NOTRADE_HUMP(i)	        (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOHUMP))
#define NOTRADE_STROKE(i)	(IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOSTROKE))
#define NOTRADE_BANG(i)	        (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOBANG))
#define NOTRADE_EFF(i)	        (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOEFF))
#define NOTRADE_FUM(i)	        (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOFUM))
#define NOTRADE_DIG(i)	        (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NODIG))
#define NOTRADE_PURR(i)	        (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOPURR))
