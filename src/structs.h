...
#define ROOM_GODROOM		(1 << 10)  /* LVL_GRGOD+ only allowed	*/
#define ROOM_HOUSE		(1 << 11)  /* (R) Room is a house	*/
#define ROOM_HOUSE_CRASH	(1 << 12)  /* (R) House needs saving	*/
#define ROOM_ATRIUM		(1 << 13)  /* (R) The door to a house	*/
#define ROOM_OLC		(1 << 14)  /* (R) Modifyable/!compress	*/
#define ROOM_BFS_MARK		(1 << 15)  /* (R) breath-first srch mrk	*/
#define ROOM_CLAN               (1 << 16)  /* Clan Room do not alter    */
#define ROOM_CASTLE             (1 << 17)  /* Used for clan castles     */
#define ROOM_REGEN              (1 << 18)  /* Used in Regen Rooms       */
#define ROOM_ARENA              (1 << 19)  /* Arena Room                */
#define ROOM_SPARE1             (1 << 20)
#define ROOM_SPARE2		(1 << 21)
#define ROOM_IMPL               (1 << 22)  /* Implementor Only Room     */
     /* this MUST be last so that it cannot be set within OLC */
#define ROOM_LOCKED_DOWN        (1 << 23)  /* Locked down room          */
...
#define EX_SECRET               (1 << 4)   /* Room is secret            */
...
#define SECT_DESERT         11             /* A Hot Place               */
...
/* temporary game flags that do not need to be saved */
#define TMP_COLOR_1           (1 << 0) /* color low bit */
#define TMP_COLOR_2           (1 << 1) /* color high bit */
#define TMP_MARRIAGE          (1 << 2) /* marriage concent flagged */
#define TMP_QUESTOR           (1 << 3) /* player is questing in autoquest   */
#define TMP_OLC               (1 << 4) /* player is using OLC           */
#define TMP_WRITING           (1 << 5) /* Player writing (board/mail)   */
#define TMP_MAILING           (1 << 6) /* Player is writing mail        */
...
#define PLR_NOEXP       (1 << 4)   /* Player gains no exp               */
#define PLR_SPARE2      (1 << 5)   /* Spare 2                           */
...
#define PLR_CRIMINAL    (1 << 17)  /* Player is a criminal              */
#define PLR_WORLD       (1 << 18)  /* Player can edit any zone          */
#define PLR_SPARE3      (1 << 19)  /* Spare 3                           */
#define PLR_SWITCH      (1 << 20)  /* player can use the switch command */
#define PLR_PK          (1 << 21)  /* player wants pk on                */
#define PLR_TESTER      (1 << 22)  /* player is tester char             */
...
#define MOB_CLAN         (1 << 18) /* Mob will attack memeber not in clan */
#define MOB_MOUNTABLE    (1 << 19) /* Is the mob mountable? (DAK)       */
#define MOB_QUESTMASTER  (1 << 20) /* Mob is the quest master           */
#define MOB_QUEST        (1 << 21) /* Mob is used in the quest          */
...
#define PRF_TICK	(1 << 4)  /* Display tick info for player	*/
#define PRF_DAMAGE	(1 << 5)  /* Display Mob Hitpoints when fight	*/
#define PRF_NOSPORTS	(1 << 6)  /* Display move points in prompt	*/
...
#define PRF_NOPAGE	(1 << 13) /* Can't receive pages.       	*/
#define PRF_AUTOASSIST	(1 << 14) /* Color (high bit)			*/
...
#define PRF_AUTOLOOT    (1 << 22) /* Sets Autolooting on                */
#define PRF_AUTOSPLIT   (1 << 23) /* Sets Autosplitting on              */
#define PRF_AUTOGOLD    (1 << 24) /* sets autolooting on                */
#define PRF_NOMUSIC     (1 << 25) /* Can't hear the music channel       */
#define PRF_NOCOMMIS    (1 << 26) /* Can't hear the Commis Channel      */
#define PRF_VNUMS       (1 << 27) /* Imms can see vnums                 */
...
#define AFF_SPARE1	      (1 << 16)	   /* Room for future Expansion	*/
#define AFF_FLYING 	      (1 << 17)	   /* Char is flying            */
...
#define AFF_HASTE             (1 << 22)    /* HASTE affection           */
#define AFF_GLOW              (1 << 23)    /* Player is Glowing         */
#define AFF_SPARE2            (1 << 24)    /* Room for future expansion */
#define AFF_DOOM              (1 << 25)    /* doom affects              */
#define AFF_TAMED             (1 << 26)    /* tamed animals for mount   */
...
#define CON_TEXTED       22             /* text editor                  */
#define CON_QPK          23             /* Getting PK Consent           */
#define CON_QANSI        24             /* Ask for ANSI support         */
#define CON_DISCONNECT   25             /* In-game disconnection        */
...
#define WEAR_HOLD      17
#define WEAR_FACE      18
#define WEAR_EAR_1     19
#define WEAR_EAR_2     20
#define WEAR_EYES      21
#define WEAR_HAIR      22
#define WEAR_ANKLE     23
...
#define ITEM_FIREWEAPON 6		/* Item is a gun type weapon	*/
#define ITEM_CLIP       7		/* Item is a clip of ammo	*/
...
#define ITEM_HERB      25       /* Item is a healing Herb to eat */
...
#define ITEM_WEAR_EAR		(1 << 16) /* Can be held		*/
#define ITEM_WEAR_EYES		(1 << 17) /* Can be held		*/
#define ITEM_WEAR_HAIR          (1 << 18) /* Can be worn in the hair    */
#define ITEM_WEAR_ANKLE         (1 << 19) /* Can be worn on the ankle   */
...
#define ITEM_ANTI_STROKE   (1 << 12)	/* Not usable by Strokin	*/
#define ITEM_ANTI_HUMP     (1 << 13)	/* Not usable by Humpin 	*/
#define ITEM_ANTI_EFF      (1 << 14)	/* Not usable by effin  	*/
#define ITEM_ANTI_BANG     (1 << 15)    /* Not for bangin               */
#define ITEM_NOSELL	   (1 << 16)	/* Shopkeepers won't touch it	*/
#define ITEM_ANTI_PURR     (1 << 17)    /* Not useable by Purrin        */
#define ITEM_ANTI_FUM      (1 << 18)	/* Not usable by Fumblin  	*/
#define ITEM_ANTI_DIG      (1 << 19)	/* Not usable by Diggin   	*/
#define ITEM_NOT_LOCATE    (1 << 20)	/* Item is not Locatebale  	*/
#define ITEM_NOT_AUCTION   (1 << 21)    /* Item can not be auctioned    */
#define ITEM_AUTOENGRAVE   (1 << 22)    /* Item is autoengraveable      */
#define ITEM_ANTI_FEMALE   (1 << 23)    /* Item can't be used be females */
#define ITEM_ANTI_MALE     (1 << 24)    /* Item can't be used by Males  */
#define ITEM_SPARE3        (1 << 25)    /* Item is not auctionable  */
#define ITEM_SPARE4        (1 << 26)    /* Item is not auctionable  */
#define ITEM_SPARE5        (1 << 27)    /* Item is not auctionable  */
#define ITEM_SPARE6        (1 << 28)    /* Item is not auctionable  */
...
#define APPLY_END		6	/* Apply to charisma		*/
...
#define APPLY_STAMINA          25       /* Apply to max stamina         */
...
#define LVL_IMPL	114
#define LVL_LOWIMPL	113
#define LVL_CREATOR     112
#define LVL_SUPREME	111
#define LVL_GRGOD	110
#define LVL_GOD         109
#define LVL_ARCHWIZ     108
#define LVL_WIZARD      107
#define LVL_RULER       106
#define LVL_GUARDIAN    105
#define LVL_OVERSEER	104
#define LVL_IMMORT      103

#define LVL_FREEZE	LVL_SUPREME
#define LVL_BAN         LVL_CREATOR
#define LVL_JAIL        LVL_GRGOD
#define LVL_SWITCH      LVL_GRGOD

/* Ok now the legend Levels */
#define LVL_HERO       100
#define LVL_KNIGHT     101
#define LVL_PRINCE     102
...
#define MAX_LANG                197 /* languages */
#define MAX_AFFECT		32  /* Used in char_file_u *DO*NOT*CHANGE* */
#define MAX_OBJ_AFFECT		6 /* Used in obj_file_elem *DO*NOT*CHANGE* */
#define POOF_LENGTH             80 /* Maximum poofin/out length */
...
struct obj_flag_data {
   ...
   int  engrave;        /* who the object is engraved too   */
...
struct room_direction_data {
  ...
  /*  char *action; */                  /* action when the player goes in that direction */
...
struct char_player_data {
   ...
   char *poofin;       /* Poofin for gods */
   char *poofout;      /* Poofout for gods */
...
struct player_special_data_saved {
   ...
   byte jail_level;             /* Level of god who jailed char, if any */
   sh_int invis_level;		/* level of invisibility		*/
   room_vnum load_room;		/* Which room to place char in		*/
   long	pref;			/* preference flags for PC's.		*/
   ubyte bad_pws;		/* number of bad password attemps	*/
   sbyte conditions[3];         /* Drunk, full, thirsty			*/
   int speaking;                /* What the Char Speaks                 */
   int spells_to_learn;		/* How many can you learn yet this level*/
   int olc_zone[3];             /* The Olc Zones assigned to the God    */
   int quest_points;            /* Quest points for player              */
   int gohome;                  /* Gohome of the player                 */
   int office;                  /* Office of the player                 */
   int married;                 /* Married to                           */
   sh_int min_wiz_lev;          /* Minimum wiz level, turn off those imms */
   int pkkills;
   int pkdeaths;
  int mobdeaths;
  ...
  ubyte nextquest;             /* Time for the Next Quest            */
  ubyte spare2;
  int spare3;
  int spare4;
  int spare5;
  long	spare6;
  dString disabled[10];        /* Disabled commands for this player    */
};
...
struct mob_special_data {
   ...
   sh_int attacks;          /* Multiple Attacks                        */
};
...
struct end_app_type {
  byte bonus;       /* how much stamina gain you get per level */
  byte stam_loss;   /* How much stamina lost per hit */
};
